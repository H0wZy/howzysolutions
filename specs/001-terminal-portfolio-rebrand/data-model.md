...
| `tooling` | Infrastructure supporting the author's own work | terminal |
...
| `functional` | Works end to end; not deployed to production | Anyone is using it | selzler-construtora, viralvideogen, terminal |
