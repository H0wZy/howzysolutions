...
export const en = {
  ...
  // CV downloads & exports
  'cv.copyPage': 'Copy Page',
  'cv.copied': 'Copied!',
  'cv.copyFailed': 'Copy failed',
  'cv.menuTrigger': 'Export options',
  'cv.viewMarkdown': 'View as Markdown',
  'cv.downloadPdfEn': 'Download PDF (EN)',
  'cv.downloadPdfPt': 'Download PDF (PT-BR)',
