...
export const pt = {
  ...
  'section.github': 'atividade_no_github',
  ...
  // Atividade no GitHub (fonte, unidade e período diferentes das estatísticas acima)
  'contrib.source': 'Fonte: GitHub',
  'contrib.window': 'de {start} a {end}',
  'contrib.stale': 'Grade da última captura bem-sucedida, em {date}.',
  'contrib.privateNote': 'Repositórios privados entram na contagem, sem nome.',
  'contrib.inLastYear': '{contributions} no último ano',
  'contrib.inYear': '{contributions} em {year}',
  'contrib.day.none': 'Nenhuma contribuição em {date}.',
  'contrib.day.some': '{contributions} em {date}.',
  'contrib.lastYear': 'último ano',
  'contrib.period': 'Período das contribuições',
  'contrib.gridLabel': 'Calendário de contribuições',
  'contrib.learnHow': 'Como o GitHub conta contribuições',
  'contrib.less': 'Menos',
  'contrib.more': 'Mais',
  'contrib.overview': 'Visão geral da atividade',
  'contrib.contributedTo': 'Contribuiu em',
  'contrib.and': 'e',
  'contrib.types': 'Tipos de contribuição, só repositórios públicos',
  'contrib.type.commits': 'Commits',
  // Termo do GitHub, usado sem tradução pela comunidade brasileira.
  'contrib.type.pullRequests': 'Pull requests',
  'contrib.type.issues': 'Issues',
  'contrib.type.reviews': 'Revisão de código',
  'contrib.activity': 'Atividade de contribuição',
  'contrib.tl.commits': 'Criou {items} em {repos}',
  'contrib.tl.created': 'Criou {repos}',
  'contrib.tl.prs': 'Abriu {items} em {repos}',
  'contrib.tl.issues': 'Abriu {items} em {repos}',
  'contrib.tl.reviews': 'Revisou {items} em {repos}',
  'contrib.tl.private': '{contributions} em repositórios privados',
  'contrib.fork': 'fork',
  'contrib.newer': 'mais recentes',
  'contrib.older': 'mais antigos',
  'contrib.pageOf': 'Página {page} de {total}',
  'contrib.n.contribution.one': '{n} contribuição',
  'contrib.n.contribution.other': '{n} contribuições',
  'contrib.n.commit.one': '{n} commit',
  'contrib.n.commit.other': '{n} commits',
  'contrib.n.repo.one': '{n} repositório',
  'contrib.n.repo.other': '{n} repositórios',
  'contrib.n.otherRepo.one': '{n} outro repositório público',
  'contrib.n.otherRepo.other': '{n} outros repositórios públicos',
