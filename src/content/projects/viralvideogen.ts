...
export const viralvideogen: Project = {
  ...
  capabilities: {
    en: [
      ...
      'A deliberate split between the image prompt, which defines visual state, and the animation prompt, which defines what changes over time — the separation that makes character consistency controllable.',
    ...
    pt: [
      ...
      'Separação deliberada entre prompt de imagem, que define o estado visual, e prompt de animação, que define o que muda no tempo — a separação que torna a consistência de personagem controlável.',
