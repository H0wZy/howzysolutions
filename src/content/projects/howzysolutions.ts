...
export const howzysolutions: Project = {
  ...
  capabilities: {
    en: [
      ...
      'One engine, two renderers: a DOM terminal that is canonical and accessible, and an opt-in immersive renderer that draws the environment in WebGL while the terminal itself stays real text.',
    ...
    pt: [
      ...
      'Um engine, dois renderers: um terminal DOM canônico e acessível, e um renderer imersivo opt-in que desenha o ambiente em WebGL enquanto o terminal continua sendo texto real.',
  ...
  stack: [
    { group: 'frontend', items: ['react', 'typescript', 'vite', 'r3f', 'threejs'] },
  ...
  development: {
    en: [
      ...
      'The 3D work from the first version is not deleted. The animated point field and the postprocessing glow are carried into the opt-in immersive renderer, so the capability survives as running code instead of a claim about the past.',
    ],
    pt: [
      ...
      'O trabalho 3D da primeira versão não é deletado. O campo de pontos animado e o brilho de postprocessing são levados para o renderer imersivo opt-in, então a capacidade sobrevive como código rodando em vez de afirmação sobre o passado.',
    ],
  },
  ...
  limitations: {
    en: [
      ...
      'The immersive renderer is the lowest-priority story and is additive: the site is complete and honest without it.',
    ],
    pt: [
      ...
      'O renderer imersivo é a story de menor prioridade e é aditivo: o site está completo e honesto sem ele.',
    ],
  },
