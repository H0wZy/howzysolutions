...
export const howzysolutions: Project = {
  ...
  capabilities: {
    en: [
      ...
      'The command engine is renderer-agnostic by construction: a second renderer (an opt-in WebGL/immersive presentation) was built, worked exactly as specified, and was later removed without touching the engine at all — proof the separation holds, not just a claim about it.',
    ...
    pt: [
      ...
      'O engine de comandos é agnóstico de renderer por construção: um segundo renderer (uma apresentação WebGL/imersiva opt-in) foi construído, funcionou exatamente como especificado, e depois foi removido sem tocar no engine — prova de que a separação se sustenta, não só uma alegação sobre ela.',
